...
/* NOTE::
* let and var are very similar when used like this outside a function block
*/
...
/* 
* Also, They are identical when used like this in a function block.
*/
...
* In example below; let is only visible in the for() loop and var is visible to the whole function.
*/
